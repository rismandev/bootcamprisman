...
$biodata = getBiodataById($_GET['id']);

?>

<form action="processedit.php?id=<?= $biodata['id']; ?>" method="post">
    <h4 class="text-center m-3">Edit Biodata</h4>
    <div class="row m-3 mt-4">
        <!-- Desktop Bagian Kiri -->
        <div class="col-md-6">
            <div class="form-group">
                <label for="full_name">Nama Lengkap</label>
                <input type="text" name="full_name" id="full_name" class="form-control" value="<?= $biodata['full_name']; ?>" required>
            </div>
            <div class="form-group row">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="place_of_birth_id" id="place_of_birth_id" class="form-control" required>
                        ...
                        <?php foreach (getCities() as $cities) : ?>
                            <!-- Jika Tempat Sama, Maka Tampilkan 1 Saja -->
                            <?php if ($biodata['name'] == $cities['name']) : ?>
                                <option value="<?= $biodata['cities_id'] ?>" selected><?= $biodata['name']; ?></option>
                            <?php else : ?>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="date_of_birth" id="date_of_birth" class="form-control" value="<?= $biodata['date_of_birth']; ?>" required>
                </div>
            </div>
            <div class="form-group">
                <label for="phone_number">No. HP</label>
                <input type="number" name="phone_number" id="phone_number" class="form-control" value="<?= $biodata['phone_number']; ?>" required>
            </div>
            <div class="form-group">
                <label for="address">Alamat</label>
                <textarea name="address" id="address" class="form-control" rows="5"><?= $biodata['address']; ?></textarea>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select name="last_education" id="last_education" class="form-control" required>
                    <option value="<?= $biodata['last_education']; ?>" selected><?= $biodata['last_education']; ?></option>
            ...
            <div class="form-group row">
                    ...
                    <div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <input type="radio" name="religion" value="<?= $biodata['religion']; ?>" class="mr-2" checked> <?= $biodata['religion']; ?>
                            </div>
                        </div>
                    </div>
                    <div class="input-group mb-2">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <input type="checkbox" name="hobby" value="<?= $biodata['hobby']; ?>" class="mr-2" checked> <?= $biodata['hobby']; ?>
                            </div>
                        </div>
                    </div>
                    <div class="input-group mb-2">
